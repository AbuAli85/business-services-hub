-- Quick Fix: Add missing amount_cents column to v_booking_status view
-- Run this in Supabase SQL Editor to fix the immediate application error

-- Drop and recreate the view with the missing amount_cents column
...
SELECT 
  ...
  b.amount_cents,                         -- App expects 'amount_cents' (FIXED!)
  b.currency,
  b.subtotal,
  b.vat_amount,
  ...
  -- Progress information (simple version)
...
-- Success message
SELECT '✅ v_booking_status view fixed - amount_cents column added!' as status;
