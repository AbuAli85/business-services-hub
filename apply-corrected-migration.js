...
-- 11. Add unique constraints before inserting data
-- Add unique constraint on service_types.name
ALTER TABLE service_types ADD CONSTRAINT unique_service_type_name UNIQUE (name);

-- Add unique constraint on service_milestone_templates (service_type_id, title)
