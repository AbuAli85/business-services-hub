-- Enhance Booking Dashboard UI and User Experience
...
BEGIN
    ...
    CASE booking_status
        ...
        WHEN 'paid' THEN
            CASE 
                WHEN progress_percentage = 0 THEN RETURN 'Approved';
                WHEN progress_percentage > 0 AND progress_percentage < 100 THEN RETURN 'In Progress';
                WHEN progress_percentage = 100 THEN RETURN 'Completed';
