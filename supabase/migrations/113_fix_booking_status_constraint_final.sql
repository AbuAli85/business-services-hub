-- Fix booking status constraint to match the correct status values
-- This ensures the constraint allows the status values we actually use in the application
