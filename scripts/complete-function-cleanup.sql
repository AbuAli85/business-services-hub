-- Complete function cleanup - handles all possible signatures
-- This script will clean up ALL duplicate functions completely

-- 1. Drop ALL possible versions of each function
-- This covers all possible parameter combinations

-- Drop all update_task versions
...
-- Drop all update_milestone_progress versions
...
-- Drop all calculate_booking_progress versions
...
BEGIN
  ...
  RAISE NOTICE '🎯 COMPLETE CLEANUP RESULTS:';
