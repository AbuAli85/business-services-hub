-- Comprehensive RLS Policy Fixes (Corrected Version)
-- This script fixes the infinite recursion and 500 errors in Supabase
-- Note: RLS policies don't support OLD/NEW syntax, so we use simpler approaches
...
DROP POLICY IF EXISTS "Authenticated users can view associated companies" ON public.companies;
