// Extended notification types for comprehensive event coverage
export type ExtendedNotificationType = 
  ...
  | 'analytics_goal_achieved'
  | 'analytics_goal_missed'
  | 'analytics_trend_detected'
  | 'analytics_anomaly_detected'
  | 'analytics_performance_alert'
  | 'analytics_capacity_warning'
  ...
  | 'integration_api_limit_reached'
  | 'integration_api_limit_reset'
  ...
  | 'support_ticket_satisfaction_survey'
  ...
  | 'compliance_certificate_expiring'
