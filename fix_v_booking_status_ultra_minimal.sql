-- Ultra minimal fix for v_booking_status view
-- Avoid any potential JSON column issues

-- Drop and recreate v_booking_status view with ultra minimal columns
DROP VIEW IF EXISTS public.v_booking_status CASCADE;

-- Create the v_booking_status view with only essential columns
...
-- Add comment
COMMENT ON VIEW public.v_booking_status IS 'Booking status with ultra minimal columns - AVOID JSON ISSUES';

-- Test the view
SELECT '✅ v_booking_status view fixed with ultra minimal columns!' as status;
