    ...
    try {
      ...
      const response = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({
          ...
          from: process.env.NEXT_PUBLIC_EMAIL_FROM_ADDRESS || 'send@marketing.thedigitalmorph.com',
          replyTo: process.env.NEXT_PUBLIC_EMAIL_REPLY_TO_ADDRESS || 'noreply@marketing.thedigitalmorph.com',
