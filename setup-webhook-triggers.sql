-- Setup Webhook Triggers for Make.com Integration
...
GRANT EXECUTE ON FUNCTION call_make_com_webhook(TEXT, TEXT, JSONB) TO authenticated;
...
-- Test the setup
SELECT 'Webhook triggers setup completed successfully!' as status;
