-- COMPREHENSIVE FIX FOR BOOKINGS PAGE
-- This fixes the loading issue and improves status, progress, and payment columns

-- 1. Ensure the v_booking_status view is working correctly
...
-- 2. Create an optimized booking list view for better performance
...
-- 5. Success message
SELECT '✅ BOOKINGS PAGE COMPREHENSIVE FIX APPLIED!' as status;
