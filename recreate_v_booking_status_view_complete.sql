-- Recreate v_booking_status view with ALL required columns for the frontend
-- This should fix the "Loading..." issue on the booking details page
...
-- Create the complete v_booking_status view with all required columns
...
-- Test the complete frontend query
SELECT 
    id,
    booking_title,
    service_id,
